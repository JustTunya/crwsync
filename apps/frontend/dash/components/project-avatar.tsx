...
export function ProjectAvatar({ icon }: { icon: HugeiconsIconProps["icon"] }) {
  return (
    <div className="flex items-center justify-center size-5 rounded-sm bg-primary inset-shadow-xs inset-shadow-white/30 shadow-sm">
