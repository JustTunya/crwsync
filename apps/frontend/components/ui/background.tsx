export default function Background() {
  return (
    <div aria-hidden="true" className="fixed top-0 -z-10 size-full bg-base-100">
      <div aria-hidden="true" className="fixed top-0 -z-10 h-full w-full bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:4rem_4rem]" />
